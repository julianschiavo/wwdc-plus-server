    ...
    static var all: [JSONEvent] {
        return [
            ...
            JSONEvent(id: "LadiesAtWWDC",
                      ...
                      description: "Enjoy an evening of fun networking, delicious appetizers, awesome swag, and themed cocktails with your fellow women-in-tech during WWDC.",
                      startDate: .default(day: 6, hour: 17, minute: 0, second: 0),
                      endDate: .default(day: 6, hour: 20, minute: 0, second: 0),
                      place: "Scott's Seafood",
                      latitude: 37.3315,
                      longitude: -121.8917,
