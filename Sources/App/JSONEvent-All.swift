    ...
    static var all: [JSONEvent] {
        return [
            ...
            JSONEvent(id: "ScholarshipKickoff",
                      ...
                      startDate: .default(day: 2, hour: 10, minute: 0, second: 0),
                      endDate: .default(day: 2, hour: 14, minute: 0, second: 0),
                      latitude: 37.3308,
                      longitude: -122.0075),
            ...
            JSONEvent(id: "Keynote",
                      ...
                      startDate: .default(day: 3, hour: 10, minute: 0, second: 0),
                      endDate: .default(day: 3, hour: 12, minute: 0, second: 0),
                      latitude: 37.3298,
                      longitude: -121.8888),
            ...
            JSONEvent(id: "StateOfTheUnion",
                      ...
                      startDate: .default(day: 3, hour: 14, minute: 0, second: 0),
                      endDate: .default(day: 3, hour: 16, minute: 0, second: 0),
                      latitude: 37.3298,
                      longitude: -121.8888),
            ...
            JSONEvent(id: "AppleDesignAwards",
                      ...
                      startDate: .default(day: 3, hour: 16, minute: 30, second: 0),
                      endDate: .default(day: 3, hour: 17, minute: 30, second: 0),
                      latitude: 37.3298,
                      longitude: -121.8888),
            ...
            JSONEvent(id: "Bash",
                      ...
                      startDate: .default(day: 6, hour: 18, minute: 0, second: 0),
                      endDate: .default(day: 6, hour: 22, minute: 0, second: 0),
                      latitude: 37.3278,
                      longitude: -121.8925),
            ...
            JSONEvent(id: "AccidentalTechPodcast",
                      ...
                      startDate: .default(day: 3, hour: 18, minute: 0, second: 0),
                      endDate: .default(day: 3, hour: 20, minute: 0, second: 0),
            ...
            JSONEvent(id: "TheTalkShow",
                      ...
                      startDate: .default(day: 4, hour: 19, minute: 0, second: 0),
                      endDate: .default(day: 4, hour: 21, minute: 0, second: 0),
            ...
            JSONEvent(id: "SwiftOverCoffeePodcast",
                      ...
                      startDate: .default(day: 5, hour: 17, minute: 30, second: 0),
                      endDate: .default(day: 5, hour: 18, minute: 30, second: 0),
            ...
            JSONEvent(id: "ConnectedPodcast",
                      ...
                      startDate: .default(day: 5, hour: 18, minute: 0, second: 0),
                      endDate: .default(day: 5, hour: 20, minute: 0, second: 0),
                      place: "Hammer Theatre",
                      latitude: 37.3337,
                      longitude: -121.8865,
            ...
            JSONEvent(id: "JamesDempseyAndTheBreakpoints",
                      ...
                      startDate: .default(day: 5, hour: 19, minute: 0, second: 0),
                      endDate: .default(day: 5, hour: 23, minute: 0, second: 0),
            ...
            JSONEvent(id: "DubDubRun030619",
                      ...
                      startDate: .default(day: 3, hour: 7, minute: 20, second: 0),
                      endDate: .default(day: 3, hour: 8, minute: 0, second: 0),
                      latitude: 37.331,
                      longitude: -121.894),
            ...
            JSONEvent(id: "NightOfDimSum030619",
                      ...
                      startDate: .default(day: 3, hour: 19, minute: 0, second: 0),
                      endDate: .default(day: 3, hour: 21, minute: 0, second: 0),
            ...
            JSONEvent(id: "DubDubRun040619",
                      ...
                      title: "Dub Dub Run",
                      description: "Kick off your mornings right with an easy 5k jog along the scenic Guadalupe River while chattting about all the fun stuff announced at WWDC.",
                      startDate: .default(day: 4, hour: 7, minute: 20, second: 0),
                      endDate: .default(day: 4, hour: 8, minute: 0, second: 0),
                      latitude: 37.331,
                      longitude: -121.894),
            ...
            JSONEvent(id: "OfficialNikeRun",
                      ...
                      startDate: .default(day: 5, hour: 7, minute: 0, second: 0),
                      endDate: .default(day: 5, hour: 8, minute: 0, second: 0),
                      latitude: 37.3298,
                      longitude: -121.8888),
            ...
            JSONEvent(id: "DubDubClimb050619",
                      ...
                      startDate: .default(day: 5, hour: 7, minute: 15, second: 0),
            ...
            JSONEvent(id: "DubDubRun050619",
                      ...
                      title: "Dub Dub Run",
                      description: "Kick off your mornings right with an easy 5k jog along the scenic Guadalupe River while chattting about all the fun stuff announced at WWDC.",
                      startDate: .default(day: 5, hour: 7, minute: 20, second: 0),
                      endDate: .default(day: 5, hour: 8, minute: 0, second: 0),
                      latitude: 37.331,
                      longitude: -121.894),
            ...
            JSONEvent(id: "DubDubClimb060619",
                      ...
                      title: "Dub Dub Climb",
                      description: "What started as a few WWDC participants hitting the rock gym is evolving! Begin your day with a fun indoor climb while meeting other WWDC folks and chatting about all the announcements, afterparties and more!",
                      startDate: .default(day: 6, hour: 7, minute: 15, second: 0),
            ...
            JSONEvent(id: "DubDubRun060619",
                      ...
                      title: "Dub Dub Run",
                      description: "Kick off your mornings right with an easy 5k jog along the scenic Guadalupe River while chattting about all the fun stuff announced at WWDC.",
                      startDate: .default(day: 6, hour: 7, minute: 20, second: 0),
                      endDate: .default(day: 6, hour: 8, minute: 0, second: 0),
                      latitude: 37.331,
                      longitude: -121.894),
            ...
            JSONEvent(id: "NightOfDimSum060619",
                      ...
                      title: "Night of Dim Sum 2019",
                      description: "Join us for a night of all-you-can-eat dim sum! Located just a couple of miles from downtown San Jose in the Westfield Valley Fair Mall (where there is also an Apple Store and a LEGO store), Din Tai Fung is internationally known as one of the world's best Shanghai dumpling restaurants.",
                      startDate: .default(day: 6, hour: 19, minute: 0, second: 0),
                      endDate: .default(day: 6, hour: 21, minute: 0, second: 0),
                      place: "Din Tai Fung (Westfield Valley Fair Mall)",
                      latitude: 37.3261,
                      longitude: -121.9441,
                      ticketLink: "https://www.eventbrite.com/e/night-of-dim-sum-2019-tickets-54087628553"),
            ...
            JSONEvent(id: "TrySwiftSanJose",
                      ...
                      startDate: .default(day: 7, hour: 10, minute: 0, second: 0),
                      endDate: .default(day: 7, hour: 17, minute: 0, second: 0),
